...
import { Typography, Row, Col, Card, Divider, Button, Icon, notification, message } from 'antd';
...
export default () => {
    const openWithType = (type) => {
        ...
        notification[type]({
            ...
            description:
                `This is the content of the notification. This is the conte
            ...
            <div>
                ...
                <Row gutter={30} type="flex" justify="center">
                    ...
                    <Col xs={24} lg={12}>
                        <Card>
                            <Button.Group>
                                <Button onClick={() => { openWithType('success') }}>
                                    Success
                            </Button>
                                <Button onClick={() => { openWithType('info') }}>
                                    Info
                            </Button>
                                <Button onClick={() => { openWithType('warning') }}>
                                    Warning
                            </Button>
                            </Button.Group>
